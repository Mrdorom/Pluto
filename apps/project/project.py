...
class Project(Resource):
    ...
    def post(self):
        """"""
        self.parse.add_argument("project_name",type=str,require=True,help="项目名称必填")
        ...
        project_obj = ProjectModel.objects.get(project_name=project_name)
        if project_obj:
            res = {"code":1000,"message":"项目已存在","data":{}}
            return format_response(res)
        project = ProjectModel(project_name=project_name,project_desc=project_desc,owner=user_id)
        project.save()
